...
/**
 * This class implements user login activity and also front end validation
 * @author Anumeha
 *
 */
...
public class LoginActivity extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Clicking on register button will open Register layout ; 
    ...
    private class processBackend extends AsyncTask<String, String, JSONObject> {
       ...
       @Override
        protected void onPreExecute() {
       	...
       	//this method  creates json request calls the  the back end apis
        @Override
        protected JSONObject doInBackground(String... args) {
            ...
            try {
            		...
            		jsonRequest.put("requestType", "login");
            		
            		StringEntity se = new StringEntity( jsonRequest.toString());
            		jsonRequest = LibraryFunctions.createURL("login", se);
        ...
        //method to handle the rest api response
        ...
        protected void onPostExecute(JSONObject json) {
        	...
        	try {
				...
				if(json.getInt("success") == 1 && json.getInt("error") == 0 ) {
					...
					videoIntent.putExtra("emailId",EMAILID );
